...
(function () {
        ...
        if (message.type === "market_item_order_books_updated") {
          ...
          fetch(
            "https://mwi-market-git-main-jo-wtfs-projects.vercel.app/api/upload_market_book",
            {
              ...
              body: JSON.stringify(consolidatedMarketData),
            }
          )
  ...
  function createUI() {
    ...
    collectButton.textContent = "采集 Item 图标";
    ...
    sendRequestsButton.textContent = "发送请求";
        ...
        const interval = setInterval(() => {
          if (index < itemsArray.length) {
            ...
            if (window.updatedMarketBook) {
              fetch(
                "https://mwi-market.vercel.app/api/upload_market_book",
                {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
